...
;; set reflowing text at 80 chars instead of 70.
...
(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((js-indent-level . 8)))))
(custom-set-faces
...
(add-hook 'perl-mode-hook 'my-enable-minor-modes)
(add-hook 'sh-mode-hook 'my-enable-minor-modes)
